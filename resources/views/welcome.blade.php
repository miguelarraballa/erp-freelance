...
<body>
  ...
  <div class="container">
    <header>
      ...
      @auth
        <a href="{{ url('/facturacion') }}" class="btn-login">Ir al panel</a>
      @else
        <a href="{{ route('filament.facturacion.auth.login') }}" class="btn-login">Iniciar Sesión</a>
      @endauth
    </header>

    <section class="hero">
      <h2>Bienvenido al <span class="gradient-text">Panel de Control</span></h2>
      <p>Accede rápidamente a los módulos del sistema de gestión empresarial</p>
    </section>

    <section class="grid">
      <a href="{{ \App\Filament\Resources\Facturas\FacturaResource::getUrl('index') }}" class="card">
        <div class="card-icon">
          <svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
        </div>
        <div>
          <h3>Facturación</h3>
          <p>Gestión de facturas, cobros y documentos fiscales</p>
        </div>
        <div class="card-link">
          <span>Acceder</span>
      ...
      <a href="{{ \Presupuestos\Filament\Resources\Presupuestos\PresupuestoResource::getUrl('index') }}" class="card">
        <div class="card-icon">
      ...
      <a href="{{ \App\Filament\Resources\Clientes\ClienteResource::getUrl('index') }}" class="card">
        <div class="card-icon">
      ...
      <a href="{{ url('/facturacion/informes') }}" class="card">
        <div class="card-icon">
      ...
      <a href="{{ url('/facturacion/') }}" class="card">
        <div class="card-icon">
